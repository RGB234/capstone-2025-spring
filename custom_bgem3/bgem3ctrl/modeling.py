...
#  Control group for BGEM3SAQ
# this model replaces sentence attention module of BGEM3SA with a BERT encoder 
# to compare fine-tuning test results with those of BGEM3 SAQ
class BGEM3CtrlModel(AbsEmbedderModel):  # class AbsEmbedderModel(ABC, nn.Module):
    ...
    #
    def _sentence_attention_embedding(self, last_hidden_state, attention_mask):
