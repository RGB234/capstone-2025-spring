...
-m bgem3ctrl \
    ...
    --cache_dir /data2/local_datasets/encoder/cache/10ep/ctrl/model \
    --cache_path /data2/local_datasets/encoder/cache/10ep/ctrl/data \
    --train_data /data2/local_datasets/encoder/data/incidents_train_minedHN.jsonl \
    --output_dir /data2/local_datasets/encoder/output/10ep/ctrl \
    --save_steps 1000 \
    --logging_steps 200 \
    --num_train_epochs 10 \
