...
-m bgem3saq \
    ...
    --cache_dir /data2/local_datasets/encoder/cache/10ep/saq/model \
    --cache_path /data2/local_datasets/encoder/cache/10ep/saq/data \
    --train_data /data2/local_datasets/encoder/data/incidents_train_minedHN.jsonl \
    --output_dir /data2/local_datasets/encoder/output/10ep/saq \
    --save_steps 1000 \
    --logging_steps 200 \
    --num_train_epochs 10 \
