...
-m bgem3sae \
    ...
    --cache_dir /data2/local_datasets/encoder/cache/bgem3_custom/5ep_sae/model \
    --cache_path /data2/local_datasets/encoder/cache/bgem3_custom/5ep_sae/data \
    --train_data /data2/local_datasets/encoder/data/relevant_incidents_train_minedHN.jsonl \
    --save_steps 500 \
    --logging_steps 100 \
    --num_train_epochs 5 \
    --dataloader_drop_last True \
    --output_dir /data2/local_datasets/encoder/bgem3_custom/5ep_sae \
